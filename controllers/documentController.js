...
export const generateReport = async (req, res) => {
  try {
    ...
    // Summary paragraph
    const summaryText = doc.summary || 'This legal document has been analyzed by LegalMind. No executive summary text was provided.';
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      if (i > 0) {
        ...
        pdfDoc.fillColor('#64748b')
              .fontSize(8)
              .font('Helvetica')
              .text('LegalMind Analysis Report', 50, 28)
      ...
      pdfDoc.fillColor('#64748b')
            .fontSize(8)
            .font('Helvetica')
            .text('Generated by LegalMind | Confidential', 50, 765);
